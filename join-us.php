            ...
            <div class="form-block w-form">
               <form id="wf-form-Contact-Us" name="wf-form-Contact-Us" data-name="Contact Us" class="main-form">
                  ...
                  <p class="max-width" style="padding-top:20px;direction:rtl">
                     نتوصل يوميا بعشرات الأسئلة الخاصة بشروط وكيفية النشر في <b style="text-decoration:underline">جفنة</b> أو الإنضمام ، ونود أن نخبر جميع المهتمين أننا نرحب بالمقالات والمساهمات التي ترد إلينا من زوار الموقع وأعضائه!
                  </p>
                  <div class="_40px-height-div"></div>
                  <div class="form-group">
                     <div class="form-grid-halves">
                     <div class="_50-percent-form-field-wrap"><label for="Last-Name-3" class="form-label" style="direction:rtl">الكنية*</label><input type="text" class="form-input w-input" maxlength="256"
                           name="Last-Name" data-name="Last Name" id="Last-Name-3" required="" /></div>
                        <div class="_50-percent-form-field-wrap">
                           <label for="First-Name-3" class="form-label">اسمك*</label>
                           <input type="text" class="form-input w-input" maxlength="256" name="First-Name" data-name="First Name" id="First-Name-3" required="" />
                        </div>
                  ...
                  <div class="form-group">
                     <div class="form-grid-halves">
                        <div class="_50-percent-form-field-wrap"><label for="Company-Name-5"
                           class="form-label">عمرك</label><input type="text"
                           class="form-input w-input" maxlength="256" name="Company-Name"
                           data-name="Company Name" id="Company-Name-5" required="" /></div>
                        <div class="_50-percent-form-field-wrap"><label for="Email-4" class="form-label">البريد الإلكتروني
                  ...
                  <div class="form-group">
                     <label for="interested-in-seeing" class="form-label">يُرجى تحديد سبب اتصالك بنا أدناه حتى نتمكن من دعم طلبك بشكل أفضل *</label>
                     <select style="padding:0;direction:rtl" id="field" name="field" required="" data-name="Field" class="form-input w-select">
